...
async function handleForgotPassword(request, env) {
  ...
  const emailResult = await sendEmail(
    ...
    normalizedEmail,
    "کد بازیابی رمز عبور",
    `<div dir="rtl" style="font-family:Tahoma,sans-serif;"><p>کد بازیابی رمز عبور شما:</p><h2 style="letter-spacing:4px;">${code}</h2><p>این کد تا ۱۵ دقیقه دیگر معتبر است.</p></div>`
  );
...
<!-- ========================= SEO Meta Tags ========================= -->
<title>ابزارک | دستیار هوش مصنوعی فارسی برای گفتگو، پاسخ‌گویی و تولید محتوا</title>
<meta name="description" content="ابزارک یک دستیار هوش مصنوعی فارسی‌زبان است که به شما در گفتگو، پاسخ به سوالات، تولید محتوا و انجام کارهای روزمره کمک می‌کند. همین حالا رایگان امتحان کنید.">
<meta name="keywords" content="ابزارک, دستیار هوش مصنوعی, هوش مصنوعی فارسی, چت بات فارسی, AI فارسی, دستیار هوشمند, چت با هوش مصنوعی">
...
<meta property="og:title" content="ابزارک | دستیار هوش مصنوعی فارسی">
<meta property="og:description" content="ابزارک یک دستیار هوش مصنوعی فارسی‌زبان است که به شما در گفتگو، پاسخ به سوالات و تولید محتوا کمک می‌کند.">
...
<meta name="twitter:title" content="ابزارک | دستیار هوش مصنوعی فارسی">
<meta name="twitter:description" content="دستیار هوش مصنوعی فارسی‌زبان برای گفتگو، پاسخ‌گویی و تولید محتوا.">
<!-- ==================================================================== -->
...
.seo-content { line-height: 1.9; }
.seo-content h2 { font-size: 1.15rem; margin-top: 0; }
.seo-content h3 { font-size: 1rem; margin: 16px 0 6px; }
.seo-content ul { margin: 6px 0; padding-inline-start: 20px; }
...
<main>
  ...
  <!-- این بخش محتوای متنی واقعی و قابل ایندکس برای موتورهای جستجو است. -->
  <div class="card seo-content" id="seo-content">
    <h2 data-i18n="seo_h1">ابزارک، دستیار هوش مصنوعی فارسی شما</h2>
    <p data-i18n="seo_intro_p1">ابزارک یک دستیار هوش مصنوعی فارسی‌زبان است که برای پاسخ‌گویی سریع، گفتگوی طبیعی و کمک به کارهای روزمره طراحی شده است. با ابزارک می‌توانید سوالات خود را بپرسید، در نوشتن متن کمک بگیرید و به پاسخ‌های دقیق و سریع دسترسی داشته باشید.</p>

    <h3 data-i18n="seo_h2_about">درباره دستیار هوش مصنوعی ابزارک</h3>
    <p data-i18n="seo_about_p1">دستیار هوش مصنوعی ابزارک به زبان فارسی گفتگو می‌کند و برای کاربران ایرانی و فارسی‌زبان طراحی شده است. هدف ابزارک ساده‌سازی دسترسی به هوش مصنوعی برای همه، بدون نیاز به دانش فنی است.</p>

    <h3 data-i18n="seo_h2_features">امکانات ابزارک</h3>
    <ul>
      <li data-i18n="seo_feature_1">گفتگوی متنی با هوش مصنوعی به زبان فارسی</li>
      <li data-i18n="seo_feature_2">پاسخ‌گویی سریع و دقیق به سوالات روزمره</li>
      <li data-i18n="seo_feature_3">حساب کاربری امن با امکان بازیابی رمز عبور</li>
      <li data-i18n="seo_feature_4">پلن‌های رایگان و اشتراکی متناسب با نیاز شما</li>
      <li data-i18n="seo_feature_5">دسترسی هم به تومان (ایران) و هم به دلار (جهانی)</li>
    </ul>

    <h3 data-i18n="seo_h2_plans">پلن‌های اشتراک</h3>
    <p data-i18n="seo_plans_p1">ابزارک یک پلن رایگان با محدودیت پیام روزانه ارائه می‌دهد و همچنین پلن‌های پایه، پیشرفته و ویژه برای کاربرانی که به پیام نامحدود و امکانات بیشتر نیاز دارند. برای کاربران خارج از ایران، پلن‌های دلاری هم موجود است.</p>
  </div>
  <!-- ==================================================================== -->
...
const translations = {
  fa: {
    ...
    seo_h1: 'ابزارک، دستیار هوش مصنوعی فارسی شما',
    seo_intro_p1: 'ابزارک یک دستیار هوش مصنوعی فارسی‌زبان است که برای پاسخ‌گویی سریع، گفتگوی طبیعی و کمک به کارهای روزمره طراحی شده است. با ابزارک می‌توانید سوالات خود را بپرسید، در نوشتن متن کمک بگیرید و به پاسخ‌های دقیق و سریع دسترسی داشته باشید.',
    seo_h2_about: 'درباره دستیار هوش مصنوعی ابزارک',
    seo_about_p1: 'دستیار هوش مصنوعی ابزارک به زبان فارسی گفتگو می‌کند و برای کاربران ایرانی و فارسی‌زبان طراحی شده است. هدف ابزارک ساده‌سازی دسترسی به هوش مصنوعی برای همه، بدون نیاز به دانش فنی است.',
    seo_h2_features: 'امکانات ابزارک',
    seo_feature_1: 'گفتگوی متنی با هوش مصنوعی به زبان فارسی',
    seo_feature_2: 'پاسخ‌گویی سریع و دقیق به سوالات روزمره',
    seo_feature_3: 'حساب کاربری امن با امکان بازیابی رمز عبور',
    seo_feature_4: 'پلن‌های رایگان و اشتراکی متناسب با نیاز شما',
    seo_feature_5: 'دسترسی هم به تومان (ایران) و هم به دلار (جهانی)',
    seo_h2_plans: 'پلن‌های اشتراک',
    seo_plans_p1: 'ابزارک یک پلن رایگان با محدودیت پیام روزانه ارائه می‌دهد و همچنین پلن‌های پایه، پیشرفته و ویژه برای کاربرانی که به پیام نامحدود و امکانات بیشتر نیاز دارند. برای کاربران خارج از ایران، پلن‌های دلاری هم موجود است.',
  },
  en: {
    ...
    seo_h1: 'Abzarak — Your Persian AI Assistant',
    seo_intro_p1: 'Abzarak is a Persian-language AI assistant built for fast answers, natural conversation, and help with everyday tasks. Ask questions, get writing help, and receive quick, accurate responses.',
    seo_h2_about: 'About Abzarak AI Assistant',
    seo_about_p1: 'Abzarak communicates in Persian (Farsi) and is designed for Iranian and Persian-speaking users. Our goal is to make AI simple and accessible for everyone, no technical knowledge required.',
    seo_h2_features: 'Features',
    seo_feature_1: 'Text conversations with AI in Persian',
    seo_feature_2: 'Fast, accurate answers to everyday questions',
    seo_feature_3: 'Secure account with password recovery',
    seo_feature_4: 'Free and paid plans to match your needs',
    seo_feature_5: 'Available in both Toman (Iran) and USD (worldwide)',
    seo_h2_plans: 'Subscription Plans',
    seo_plans_p1: 'Abzarak offers a free plan with a daily message limit, plus Basic, Plus, and Pro plans for users who need unlimited messages and more features. USD plans are available for users outside Iran.',
  }
};
...
export default {
  async fetch(request, env) {
    ...
    // robots.txt برای راهنمایی خزنده‌های گوگل و سایر موتورهای جستجو
    if (url.pathname === "/robots.txt" && request.method === "GET") {
      const baseUrl = env.PUBLIC_BASE_URL || url.origin;
      return new Response(renderRobotsTxt(baseUrl), {
        headers: { "Content-Type": "text/plain; charset=utf-8" },
      });
    }

    // sitemap.xml برای کمک به ایندکس شدن صفحات در گوگل
    if (url.pathname === "/sitemap.xml" && request.method === "GET") {
      const baseUrl = env.PUBLIC_BASE_URL || url.origin;
      return new Response(renderSitemapXml(baseUrl), {
